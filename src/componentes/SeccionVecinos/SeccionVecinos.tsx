    ...
    <section className="seccion-vecinos" id="vecinos">
      <div className="contenedor seccion-vecinos__contenido">
        <div className="seccion-vecinos__imagen">
          ...
          <img src={regalon} alt="El Regalón invitando a los vecinos" />
        </div>

        <div>
          <span className="etiqueta-seccion">Para vecinos</span>
          <h2 className="titulo-seccion">Ser Regalón tiene beneficios</h2>
